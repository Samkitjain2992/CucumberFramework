Feature: Registration Page
  ...
  Background: Common login step
    ...
    When User enters create an account EmailAddress filed as"samkitjain007@gmail.com"
...
#    When User enters create an account EmailAddress filed as"@gmail.com"
  ...
  Scenario: Validate email filed on registration page
    Given Registration Page
    And Email id should display which enter while registration as "samkitjain007@gmail.com"
